...
Usage (from repo root):
    .venv/bin/python scripts/oracle/pin_coverage.py bge-large      # one model
    .venv/bin/python scripts/oracle/pin_coverage.py --all          # every model
    .venv/bin/python scripts/oracle/pin_coverage.py bge-large --download   # fetch first
"""
import argparse
import json
import sys
